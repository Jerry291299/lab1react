      ...
      <div className="container">
        <div className="row p-5">
          <div className="mx-auto col-md-8 col-lg-6 order-lg-last">
            <img
              className="img-fluid"
              src="https://hips.hearstapps.com/hmg-prod/images/2024-nissan-gt-r-119-1673621285.jpg"
              alt=""
            />
          </div>
          <div className="col-lg-6 mb-0 d-flex align-items-center">
      ...
      <div className="container">
        <div className="row p-5">
          <div className="mx-auto col-md-8 col-lg-6 order-lg-last">
            <img
              className="img-fluid"
              src="https://www.goodcarbadcar.net/wp-content/uploads/2011/01/Nissan-GT-R-scaled.jpeg"
              alt=""
            />
          </div>
          <div className="col-lg-6 mb-0 d-flex align-items-center">
